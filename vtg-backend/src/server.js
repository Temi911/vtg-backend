...
app.use('/api/auth',authLimiter,authRoutes); app.use('/api/products',productsRoutes); app.use('/api/orders',ordersRoutes); app.use('/api/lc',lcRoutes); app.use('/api/wallet',walletRoutes); app.use('/api/payments',paymentsRoutes); app.use('/api/documents',documentsRoutes); app.use('/api/shipments',shipmentsRoutes); app.use('/api/messages',messagesRoutes); app.use('/api/compliance',complianceRoutes); app.use('/api/notifications',notificationsRoutes); app.use('/api/preferences',preferencesRoutes); app.use('/api/location',locationRoutes); app.use('/api/communications',communicationsRoutes); app.use('/api/i18n',i18nRoutes); app.use('/api/ai',aiRoutes); app.use('/api/trade',tradeRoutes); app.use('/api/marketplace',marketplaceRoutes); app.use('/api/media',mediaRoutes); app.use('/api/storefront-admin',storefrontAdminRoutes);
...
app.get('/',(req,res,next)=>{fs.readFile(frontendEntry,'utf8',(err,html)=>{if(err)return next(err);const script=`<script>${intelligenceWidget}</script><script>${marketplaceWidget}</script>`;res.type('html').send(html.includes('</body>')?html.replace('</body>',script+'</body>'):html+script)})});
