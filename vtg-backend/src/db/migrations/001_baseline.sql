-- VTG baseline migration
-- Generated from the existing production schema.
-- New production schema changes must be added as new numbered migrations.
-- Do not edit this migration after it has been applied to a production database.
